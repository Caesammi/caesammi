...
export default {
  ...
  mounted() {
    ...
    console.log(tools.zcFuzzyQuery(testList, '一','name'))


    //
    // let ttt= '2020-01-09 22:59:09'
    // let ddd = null
    // console.log(tools.zcUndefined(ddd))
    // console.log(Date.parse(ttt)); //默认毫秒
    //
    // console.log('获取日期')
    // console.log(tools.timestempToTime(1578581949000));
    // let myEdate = {
    //   dd:'ss',
    //   cc:'dd'
    // }
    // tools.zcClearObj(myEdate)
    // console.log(myEdate)
    ...
    //     value: 2
    //   }];
    // let myTest = tools.zcQuchong( [1,2,2,3,4,4,5,5])
    // console.log(myTest)
    // console.log('-----------------------------------------------')
    // return
    // setTimeout(()=>{
