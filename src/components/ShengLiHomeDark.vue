      ...
      <el-col :span="8">
        <el-col class="marginTopTen">
          ...
          <el-col style="font-size: 14px;padding-bottom: 15px;padding-left: 10px;padding-right: 10px;position: relative"
                  class="paddingAllTen midContainerDark DarkTheme">
            ● 总投资:4.3亿元 <br>
            ● 开工日期: 2013年3月23日 <br>
            ● 计划投科日期: 2013年4月2日
        ...
        <el-col class="marginTopTen">
          ...
          <el-col style="padding-bottom: 20px;" class="midContainerDark DarkTheme">
            <el-col :span="8">
          ...
          <el-col
            ...
            <el-col style="margin-top: 20px;background: transparent" class="paddingAllTen">
              ...
              <el-col style="margin-top: 20px;line-height: 1">
                ...
                <el-col :span="18">
                  <el-progress :stroke-width="13" :percentage="50"></el-progress>
                </el-col>
              </el-col>
      ...
      <el-col :span="16">
        <el-col class="marginTopTen" :span="12">
          <el-col>
            ...
            <el-col class="midContainerDark DarkTheme" style="padding-bottom: 10px">
        ...
        <el-col class="Dark" :span="24">
          ...
          <el-col :span="12" style="margin-top: 10px">
            <el-col>
              ...
              <el-col class="midContainerDark DarkTheme" style="padding-left: 10px">
          ...
          <el-col :span="12" style="margin-top: 10px">
            <el-col>
              <el-col class="smallTitleDark commonFlexStart">
                变更管理
              ...
              <el-col class="midContainerDark DarkTheme" style="padding-top:20px;padding-bottom: 20px">
                <el-col :span="12">
